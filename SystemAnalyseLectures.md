...
3. Глубина декомпозиции должна быть такой, чтобы на нижнем уровне были независимые задачи (без выбора одной из двух альтернатив). Они должны быть обеспечены иформа

 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE4NDA3Njc4NCwxMTYxMjY4NzA1LDE2OT
